This project was about creating a sorting algorithm that sorts a random set of numbers using two stacks. The twist: we could only use a limited amount of moves to do it.
